...
public class PDFService {
    ...
    @Async
    public CompletableFuture<File> generatePDF(Map<String, Object> variables, String templateName) throws Exception {
        Context context = createContext(variables);
        String html = templateEngine.process(templateName, context);
        return renderPDF(html);
    }

    private CompletableFuture<File> renderPDF(String html) throws Exception{

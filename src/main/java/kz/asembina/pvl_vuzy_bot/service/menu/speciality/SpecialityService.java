package kz.asembina.pvl_vuzy_bot.service.menu.speciality;

import kz.asembina.pvl_vuzy_bot.egovapi.DataObjectService;
import kz.asembina.pvl_vuzy_bot.egovapi.Vuz;
import kz.asembina.pvl_vuzy_bot.model.Degree;
...
public class SpecialityService {
    ...
    public String searchByKeyword(String keyword, long chatId, String lang){
        ...
        for (Vuz v:vuzy) {
            ...
            if (temp.toString().isEmpty()){
                temp.append("<i>").append(localeService.getMessage("search.not_found", lang)).append("</i>").append("\n");
            }
            result.append(temp.toString());
            result.append("\n");
        }
        result.append("<b><i>").append(localeService.getMessage("total", lang));
